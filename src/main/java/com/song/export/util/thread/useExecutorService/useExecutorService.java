package com.song.export.util.thread.useExecutorService;

import com.song.export.util.thread.extendsThread.LearnExtendsThread;
...
public class useExecutorService {
    ...
    /**
     * 来多少，建多少
     *      CachedThreadPool对任务的处理策略是提交的任务会立即分配一个线程进行执行，
     *      线程池中线程数量会随着任务数的变化自动扩张和缩减，
