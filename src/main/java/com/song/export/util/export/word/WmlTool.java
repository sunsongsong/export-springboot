...
public class WmlTool {
    ...
    public WmlTool(String fileResource) throws FileNotFoundException, Docx4JException {
        ...
        this.wmlPackage = WordprocessingMLPackage.load(new FileInputStream(file));
     ...
     *
     */
    public WmlTool() throws Docx4JException {
...
/*
        ...
        xml.append("    </w:pPr> ");
        xml.append("    <w:r> ");
        xml.append("        <w:t></w:t> ");//可添加内容 xml.append("        <w:t>目录</w:t> ");
        xml.append("    </w:r> ");
        xml.append("</w:p> ");
    ...
    private void addHeading(String headingNum, String headingText, HeadingStyle headingStyle) throws JAXBException {
        ...
        String pStyle = headingStyle.getPStyle();//Heading1 Heading2
        int blank = headingStyle.getGrade();//1 2
        while (blank > 1) {// 按级缩进
            heading = " " + heading;
            blank--;
        }
    ...
    private void createHeading(String headingNum, String headingText, HeadingStyle headingStyle){
        ...
        PPrBase.PStyle pStyle = this.wmlFactory.createPPrBasePStyle();//段落样式
