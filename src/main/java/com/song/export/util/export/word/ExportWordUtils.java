...
public class ExportWordUtils {
    ...
    public static void createWord(List<Map<String,String>> resultList,HttpServletResponse response) throws Exception{
        ...
        String corgName = "";
        String logoName = "";
        //System.out.println("logoName is : " + logoName);
        String fileName = null;
        String title = corgName + "舆情资讯简报";
        String subtitle = "(" + df.format(new Date()) + ")";
        //documentPart.addStyledParagraphOfText("Title", corgName + "舆情资讯简报" + "(" + df.format(new Date()) + ")");
        org.docx4j.wml.P p1 = createStyledText(title, "bold", "CENTER", "40");
        org.docx4j.wml.P p2 = createStyledText(subtitle, "bold", "CENTER", "32");
        ...
        //documentPart.addParagraphOfText("新闻目录：");
	    /*org.docx4j.wml.P p3 = createStyledText("新闻目录：", "bold", "LEFT", "28");
        ...
        for(int i=0;i<resultList.size();i++) {
            ...
            documentPart.addStyledParagraphOfText("Heading1", getMapValueByKey(map,"title"));
            documentPart.addParagraphOfText(getMapValueByKey(map,"time"));

            String strPubTime = createBoldUnboldText("时间：", getMapValueByKey(map,"time"));
            String strSource = createBoldUnboldText("来源：", getMapValueByKey(map,"source"));
            String strSummary = createBoldUnboldText("摘要：", getMapValueByKey(map,"summary"));
            ...
            //documentPart.addParagraphOfText("链接：" + UFD.getDocreference());
            ...
            String newsContent = getMapValueByKey(map,"content");
            if(newsContent != null){
    ...
    public static Hdr getHdr(WordprocessingMLPackage wordMLPackage,
        ...
        String logoPath = request.getSession().getServletContext()
                .getRealPath("/");

        File file = new File(logoPath + "/logo/" + logoName + ".png" );
