...
-- Records of appuser
-- ----------------------------
INSERT INTO `appuser` VALUES ('1', '张三三');
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='用户';

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'ahl', '123456', '安华亮', '安华亮', '18231197044', '西安', '', 'admin', null, null, '2018-03-12 09:35:18', '2018-04-02 15:40:26', '2018-09-13 14:32:15', '1', null, '2000', '张军测试号');
